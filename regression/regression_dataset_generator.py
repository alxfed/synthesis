"""
Synthesis of datasets for regression.
Note: Without a tambourine and Animal-speak.
"""
...
def create_regression_dataset(numberof_points=100,
    ...
    :param model_rank:
    :param numberof_other_variables: dependent variables or hidden variables.
    ...
    underlying_model = np.zeros((numberof_variables, numberof_other_variables))

    model_rank = min(numberof_variables, model_rank)
    underlying_model[:model_rank, :] = 100 * generator.rand(
        model_rank, numberof_other_variables)
